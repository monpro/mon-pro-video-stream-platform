 ...
 *
 * It's pretty fast and suitable to be used as heavy networking communication.
 */
...
public class AESUtil {
  ...
  public AESUtil(final String seed) throws Exception {
    this.seed = seed;
  ...
  public String decrypt(final String content) throws Exception {
    byte[] bytes = Base64.decodeBase64(content);
    byte[] result = decryptCipher.doFinal(bytes);
    return new String(result, StandardCharsets.UTF_8);
  }

  public String encrypt(final String content) throws Exception {
